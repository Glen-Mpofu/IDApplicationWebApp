<%-- 
    Document   : view_by_gender_outcome
    Created on : 12 May 2025, 3:29:31 PM
    Author     : Tshepo Mpofu
--%>
...
<html>
    <head>
        ...
        <title>View Applicants By Gender Page</title>
    </head>
    <body>
        <h1>View Applicants By Gender</h1>
        <h3>Male Applicants</h3>
        <%
            List<Applicant> femaleApplicants = (List<Applicant>)request.getAttribute("femaleApplicants");
            List<Applicant> maleApplicants = (List<Applicant>)request.getAttribute("maleApplicants");
        %>
        <table border="1">
            <thead>
                <tr>
            ...
            <tbody>
                <%
                    for (int i = 0; i < maleApplicants.size(); i++) {                            
                        Applicant applicant = maleApplicants.get(i);
            ...
            <tbody>
                <%
                    for (int i = 0; i < femaleApplicants.size(); i++) {                            
                        Applicant applicant = femaleApplicants.get(i);
                        Address address = applicant.getAddress();
                        List<Guardian> gs = applicant.getGuardian();
